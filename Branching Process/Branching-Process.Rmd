...
# Functions For Generating Branching Process & Probability Generating Functions
```{r}
...
# Supercritical Case: \( \mu  \) of Probability Generating Function > 1
...
# Critical Case: \( \mu  \) of Probability Generating Function = 1
...
# Subcritical Case: \( \mu  \) of Probability Generating Function < 1
...
# Poisson Probability Generating Function with \( \lambda \) = 5, up to n=10
